...
class Octant : public torch::CustomClassHolder
        ...
        public:
            ...
            // }
            void set_feature_index_(){
                feature_index_ = feature_next_index_++;
            }
            void set_node_index_(){
...
class Octree : public torch::CustomClassHolder
        ...
        public:
            Octree();
            ~Octree();
            void init(int64_t grid_dim, int64_t grid_num, double voxel_size, int64_t full_depth);
...
//            int **vox_has_value;
        ...
        private:
            ...
            void buildFullTreeRec(Octant* node,
                        int64_t     depth,
                        int64_t full_depth);  
        };