...
vertex_offsets3 = 1 - vertex_offsets2  # flipped version of offsets2
...
def trilinear_interpolation(points: torch.Tensor, per_point_vertex_values: torch.Tensor):
    """
...
def ga_trilinear(
    ...
    results = trilinear_interpolation(p, per_point_vertex_values)  # (n_points,)
    return results
