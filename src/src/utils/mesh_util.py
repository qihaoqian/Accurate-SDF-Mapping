...
class MeshExtractor:
    ...
    def create_mesh(self, decoder, map_states, voxel_size, voxels,
                    ...
                    require_color=False, offset=-10, res=8, return_sdf_priors=True):

        sdf_grid = get_scores(decoder, map_states, voxel_size, bits=res, model=self.model, return_sdf_priors=return_sdf_priors)  # (num_voxels,res*3,4)
